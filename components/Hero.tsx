  ...
  return (
    <Box>
      ...
      <Box
        sx={{
          minHeight: "100vh",
          backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.5)), url('${getAssetPath('/assets/hero-bg.jpg')}')`,
        ...
        <Container sx={{ mt: 4, display: "flex", flexDirection: "column", minHeight: "calc(100vh - 64px)" }}>
          <Toolbar disableGutters sx={{ justifyContent: "space-between", color: "white", alignItems: "center" }}>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Box component="img" src={getAssetPath("/assets/logo.png")} alt="The Trainers Locker" sx={{ height: 60, objectFit: "contain" }} />
            </Box>
